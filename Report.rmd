...
After the merger reconciliation above, 329 of 2,735 observations (12.0%) still have missing values in the income variable (`INCOME_VALUE`). These remaining gaps arise from two causes:
