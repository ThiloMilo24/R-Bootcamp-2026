...
**Income is not a meaningful predictor of burglary rates.** Contrary to the intuition behind H1, wealthier municipalities in Canton Zurich do not experience systematically higher burglary rates. The exploratory scatterplot showed no meaningful relationship, and the Negative Binomial regression confirmed that income is not statistically significant once overdispersion is properly accounted for. This suggests that the "wealthy municipalities attract burglars" narrative, while intuitively appealing, does not hold up to empirical scrutiny in this context.

**Border proximity is the strongest spatial predictor.** Municipalities closer to the Swiss national border consistently exhibit higher burglary rates, a pattern that persists across the entire observation period (2009--2024) and survives formal modelling. Each additional kilometre away from the border is associated with a measurable decrease in the expected burglary rate. This finding supports H2 and aligns with the hypothesis that proximity to international borders may facilitate cross-border property crime.

**The combined effect of income and border proximity does not improve prediction.** The interaction model (H3) did not yield a significant interaction term. Income and border proximity do not amplify each other's effects -- border distance matters regardless of income level, and income remains irrelevant regardless of distance to the border.

**Burglary rates have declined substantially over time.** Across all municipalities and border distance categories, burglary rates have fallen markedly since 2009. This canton-wide trend is captured by the year variable in the model and likely reflects broader factors such as improved security measures, changes in policing strategies, or shifts in criminal behaviour.

## Limitations

Several limitations should be considered when interpreting these results.

**Ecological fallacy.** All analyses operate at the municipal level. We observe that municipalities closer to the border have higher burglary rates, but we cannot conclude that individual burglaries are committed by cross-border offenders. The spatial pattern could reflect other correlated factors.

**Centroid distance as a proxy.** Border distance is measured from each municipality's geographic centroid to the nearest national border. This is a simplification -- municipalities with irregular shapes or large areas may have actual border distances that differ substantially from the centroid measure.

**No causal identification.** This is an observational study. The associations we find between border distance and burglary rates could be driven by unobserved confounders such as urbanisation, transport infrastructure, policing intensity, or local socioeconomic conditions that correlate with border proximity.
